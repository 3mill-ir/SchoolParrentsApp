package com.hezare.mmv.ChatMain;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView)findViewById(R.id.name_name)).setText(name);
    ...
    private void DoLoadRecent(int i) {
        ...
        final String OvliaChatID = preferences.getString("OvliaChatID", "");

        SendRequest.SendPostReadChat(OvliaChatID,F_OvliaID,i);
    ...
    private void sendMessage(final String message) {
       // mAdapter.setItemState(mAdapter.getItemCount() - 1,0);
        ...
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(ChatActivity.this);
        final String OvliaChatID = preferences.getString("OvliaChatID", "");
        SendRequest.SendPostSendChat(message,OvliaChatID,F_OvliaID);
