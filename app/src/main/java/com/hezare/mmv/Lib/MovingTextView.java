...
public class MovingTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    public static final int DEFAULT_TIME_OUT = 1500;
    ...
    public MovingTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public MovingTextView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr);
        init();
        handleAttrs(attrs);
    }
     ...
     */
    private void init() {
        fadeInAnimation = AnimationUtils.loadAnimation(getContext(), R.anim.move);
    ...
    private void handleAttrs(AttributeSet attrs) {
        ...
        this.timeout = Math.abs(a.getInteger(R.styleable.fading_text_view_timeout, 1500)) + getResources().getInteger(android.R.integer.status_bar_notification_info_maxnum);
        a.recycle();
    }
